...
if __name__ == "__main__":
    ...
    if args.server:
        ...
        obs = {
            ...
            # "annotation.human.action.task_description": ["Please do your thing! Tell me what you are doing. Remember you are a robot."],
        ...
        action = policy_client.get_realtime_action(obs)
