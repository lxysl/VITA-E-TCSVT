...
class Config:
    ...
    # Dataset parameters
    dataset_path: str = "/root/Isaac-GR00T/dataset/libero_object_no_noops_lerobot"
    """Path to the dataset directory."""

    output_dir: str = "/root/Isaac-GR00T/checkpoints/libero_object_20000"
    """Directory to save model checkpoints."""

    data_config: str = "libero_object"
