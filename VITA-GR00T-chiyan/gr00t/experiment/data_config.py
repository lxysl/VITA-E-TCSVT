...
from gr00t.model.transforms import GR00TTransform, VitaGR00TTransform
...
class LiberoObjectDataConfig(BaseDataConfig):
    video_keys = [
        "video.image",
        "video.wrist_image",
    ]
...
DATA_CONFIG_MAP = {
    ...
    "libero_object": LiberoObjectDataConfig(),
    "libero_goal": LiberoObjectDataConfig(),
    "libero_90": LiberoObjectDataConfig(),
    "libero_10": LiberoObjectDataConfig(),
