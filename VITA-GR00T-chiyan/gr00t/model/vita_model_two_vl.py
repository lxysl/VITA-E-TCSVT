...
class VITAModel(nn.Module):
    def __init__(
        ...
        self.qs = "These two images are views of the same robotic arm from the front and its end effector position. Play the role of the robot arm in the picture. Based on the given task instructions, analyze the color and shape of the objects in front of you, and understand the relative position between the end effector of the robot arm and these objects. Provide as much information as possible to complete the task. Ignore objects that are not relevant to the task. Task instructions: close the drawer"
