...
class VITAModel(nn.Module):
    ...
    def init_model(self,
        ...
        if load_separately:
            ...
            self.tokenizer, self.model, self.image_processor, context_len = load_pretrained_model(
                                                                                ...
                                                                                load_act_tokenizer=True
                                                                            )
            # num_added_tokens = self.tokenizer.add_tokens("<ACT>")
            # seg_token_idx = self.tokenizer("<ACT>", add_special_tokens=False).input_ids[0]
            
            self.model.resize_token_embeddings(len(self.tokenizer))
            # print("!!!!!", len(self.tokenizer)) # 151665->151666
    ...
    def set_trainable_parameters(self):
        ...
        # act_token = "<|ACT|>"
        # token_id = self.tokenizer.convert_tokens_to_ids(act_token)
        # print("token_id: ", token_id)  # 151665
