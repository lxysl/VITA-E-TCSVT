...
class Gr00tPolicy(BasePolicy):
    ...
    def get_realtime_action(self, 
        ...
        # print("prev_action_chunk!! ", prev_action_chunk.shape) # torch.Size([1, 16, 32])
        ...
        # print(model_pred.keys())
        normalized_action = model_pred["action_pred"].float()
        # print("normalized_action!! ", normalized_action.shape) # torch.Size([1, 16, 32])
        # print(prev_action_chunk.shape, normalized_action.shape)
        ...
        # next_action_chunk = torch.cat(
        #         (
        #             normalized_action[:, execute_horizon:],
        #             torch.zeros((normalized_action.shape[0], execute_horizon, normalized_action.shape[2])).to(device=normalized_action.device)
        #         ), dim=1)
